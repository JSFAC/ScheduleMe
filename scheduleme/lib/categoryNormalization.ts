...
const CATEGORY_DEFS: CategoryDef[] = [
  ...
  },
  {
    ...
    keywords: ['design', '3d', 'printing', 'print', 'cad', 'prototype', 'fusion', 'solidworks', 'blender', 'model'],
  },
  {
    key: 'photography',
    label: 'Photography',
  ...
  },
  {
    ...
    keywords: ['music', 'audio', 'song', 'instrument', 'guitar', 'piano', 'drum', 'dj', 'beat', 'mix', 'master', 'vocal'],
  },
  {
    ...
    keywords: ['electronic', 'tech', 'device', 'computer', 'pc', 'laptop', 'phone', 'console', 'hardware', 'arduino', 'raspberry', 'solder', 'robot', 'tinker'],
  },
  {
    key: 'pest_control',
    label: 'Pest Control',
