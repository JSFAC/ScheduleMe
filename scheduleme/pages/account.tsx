              ...
              <div className="space-y-3">
                ...
                <div className="rounded-2xl border p-6" style={{ background: cardBg, borderColor: cardBorder }}>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Link href="/support" className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-medium border transition-colors"
                      style={{ borderColor: cardBorder, color: textPrimary, background: 'transparent' }}>
                      Contact Support
                      <span style={{ color: textMuted }}>→</span>
                    </Link>
