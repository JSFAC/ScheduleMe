...
{activeBiz && <BusinessProfile biz={activeBiz} onClose={() => setActiveBiz(null)} />}
      ...
      <button onClick={() => setShowFeedback(true)}
        className="fixed right-4 md:right-6 bottom-[calc(env(safe-area-inset-bottom,0px)+78px)] md:bottom-8 z-30 flex items-center gap-2 px-3.5 py-2 rounded-full shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
        style={{ background: '#0F766E', color: 'white' }}>
        <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
