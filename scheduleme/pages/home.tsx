    ...
    <div className="w-full">
      ...
      <div className="mt-3 overflow-hidden" style={{
        ...
        <div
          ...
          style={{ scrollbarWidth: 'none', cursor: 'grab', touchAction: 'auto' }}
        >
    ...
    <>
      ...
      <div className="min-h-screen pb-[calc(108px+env(safe-area-inset-bottom,0px))] md:pb-0" style={{ paddingTop: 'calc(48px + env(safe-area-inset-top, 0px))', background: 'var(--page-bg, #F4EFE6)' }} data-page-bg="true">
        ...
        <div className="border-b" style={{ background: dm ? '#171717' : 'white', borderColor: dm ? '#262626' : 'rgba(0,0,0,0.06)' }}>
          <div className="flex gap-1.5 overflow-x-auto px-6 py-3" style={{ scrollbarWidth: 'none', justifyContent: 'safe center', touchAction: 'auto' }}>
...
{activeBiz && <BusinessProfile biz={activeBiz} onClose={() => setActiveBiz(null)} />}
      ...
      <button onClick={() => setShowFeedback(true)}
        className="fixed right-4 md:right-6 bottom-[calc(env(safe-area-inset-bottom,0px)+84px)] md:bottom-8 z-30 flex items-center gap-2 px-3.5 py-2 rounded-full shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
        style={{ background: '#0F766E', color: 'white' }}>
        <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
