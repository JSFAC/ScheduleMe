...
const NAV: { id: TabId; label: string; d: string }[] = [
  ...
  { id: 'preview',   label: 'Preview',   d: 'M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z M15 12a3 3 0 11-6 0 3 3 0 016 0z' },
          ...
          <main className="flex-1 px-6 py-7 max-w-5xl mx-auto w-full">
            ...
            {tab === 'preview' && (
              <div className="space-y-5">
                ...
                <div className="rounded-2xl border p-4" style={{ background: dm ? 'rgba(10,132,255,0.08)' : '#EBF4FF', borderColor: dm ? 'rgba(10,132,255,0.2)' : 'rgba(10,132,255,0.15)' }}>
                  <p className="text-xs font-semibold" style={{ color: '#0A84FF' }}>
                    Go to Settings to update your photos, description, and service tags — they'll reflect here instantly.
                  </p>
                </div>
              </div>
            )}
